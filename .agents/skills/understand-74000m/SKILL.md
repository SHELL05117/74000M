...
- Driver test: left-stick single-stick Curvature with automatic low-throttle Quick Turn, 12 V command ceiling, aggressive 50 ms full-scale Slew candidates, Coast stops, and hold `B` to force Coast.
